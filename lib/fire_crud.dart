...
void main(List<String> args) async {
  ...
  dir = await Directory('gen/fire_crud').create(recursive: true);
  fileName = '${dir.path}/fire_crud.dart';
  file = await File(fileName).create(recursive: true);
  file = await File(fileName).writeAsString(firebaseText);
}

final String firebaseText = """import 'dart:developer';
